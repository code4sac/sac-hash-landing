<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		$twitter_wrap_open   = '',
		$twitter_wrap_close  = '',
		$tweet_wrap_open     = '<div align="center"><p class="home-tweet-tweet">',
		$meta_wrap_open      = '<br/><span class="home-tweet-date">',
		$meta_wrap_close     = '</span>Tweets via <a href="http://www.twitter.com/SacHashtagProj" target="_blank">@SacHashtagProj</a>',
		...
		$consumerkey         = "MPoSyRWVkcQzKABW6oI2Ng";
		$consumersecret      = "OQrqKwU4TvHvCXLVNsT9rm6JexqFly2XlbidybNc";
		$accesstoken         = "15024726-QeQWVagOIoUDjjs7JtdeHRtxQKcQZXWAGmailUBDD";
		$accesstokensecret   = "KQMZCAtvb7oHKaYraWWPAe1gmIgZUsWDFGhDBTQSNVgk6";
	...
	display_latest_tweets('SacHashtagProj');
?>
